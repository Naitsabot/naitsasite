...
draft: false
summary: Fifth Semester.
gitlinks: []
---

# Enriching Dataset metadata (Fall 2025)

Wholehardedly the most boring project I have been part of.
The fifth semester of the software bachelor is about working with agile practices - so... SCRUM - in a multi-project, here [ODINI](https://odini.net/), with other groups across the semester, different studies, and with the prople of the organisation as well. 
Out focus was on incooporating metadata into the backend of ODINI, together with optimising some databse work. This involved a FastAPI backend, GCP (bigquery and storage buckets).
